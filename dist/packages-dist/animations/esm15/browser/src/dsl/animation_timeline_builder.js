...
import { DynamicTimingAst, KeyframesAst, StyleAst } from './animation_ast';
 ...
 * @return {?}
 */
export function buildAnimationTimelines(driver, rootElement, ast, startingStyles = {}, finalStyles = {}, options, subInstructions, errors = []) {
...
const /** @type {?} */ DEFAULT_NOOP_PREVIOUS_NODE = ({});
